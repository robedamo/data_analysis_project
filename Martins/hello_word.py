...
#different RP
#The information has been taken from: https://www.amb.cat/s/es/web/area-metropolitana/municipis-metropolitans.html
...
reg_poli["daily patrols per pobl"] = [rp_df.loc[rp, "daily patrols"]/pobl_df.loc[rp, "Població"]*1000 for rp in reg_poli.index]
...
for index, row in reg_poli.iterrows():
    ...
    plt.annotate(row['RP'], xy=xy[0], xytext=xytext[0], horizontalalignment='center', verticalalignment='center', fontsize=6)
    plt.axis('off')
...
reg_poli.plot(column='daily patrols per area', 
              ...
              legend=True, 
              cmap="Reds",
              legend_kwds={'label': "Logarithm of mean daily patrols per area"})
...
reg_poli.plot(column='daily patrols per pobl', 
              ...
              legend=True, 
              cmap="Reds",
              legend_kwds={'label': "Mean daily patrols per 1000 inhabitants"})
